...
@REM Auto-detect JDK 25 (Paper 26.2+), fallback JDK 21
...
for /d %%i in ("C:\Program Files\Microsoft\jdk-25*") do set "JAVA_HOME=%%~i"
if not "%JAVA_HOME%"=="" goto OkJHome

@REM Fallback: known Temurin installs
...
echo.
echo Error: JAVA_HOME not found. Set JAVA_HOME to JDK 25 (recommended for Paper 26.2).
echo Example: set "JAVA_HOME=C:\Program Files\Eclipse Adoptium\jdk-25.0.4.101-hotspot"
echo.
goto error
